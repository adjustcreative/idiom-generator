...
class IdiomList{
	...
	// get random idiom with no back-to-back
	getRandom(){
		var r = parseInt(Math.random()*this.list.length);
		// make sure it's not the same as last time..
		if(r == this.previousRandomNumber){
			r += 1;
			// now make sure it's not out of the array..
			if( r > this.list.length ) r = 0;
		}
		// set the history random..
		this.previousRandomNumber = r;
		// return the random num
		return this.list[r];
	}
}

module.exports = IdiomList;
...
},{"./ColorUtil.js":1,"./IdiomList.js":2,"./ImageMgr.js":3,"jquery":5}],5:[function(require,module,exports){
/*!
